...
interface IListSearchAction extends Action<typeof ACTION_TYPES.LIST.SEARCH> {
  payload: SearchString;
}

interface IListFilterAction extends Action<typeof ACTION_TYPES.LIST.FILTER_TOGGLE> {
  payload: FilterName;
}

interface IListSortingAction extends Action<typeof ACTION_TYPES.LIST.SORTING_TOGGLE> {
  payload: SortingName;
}

interface IListPageAction extends Action<typeof ACTION_TYPES.LIST.NEXT_PAGE> {
  payload?: undefined;
}
